# Decision Timeline Slice-5 Hardening — DT08
...
| Export/UI parity | Export copies Slice-2 event/gap codes; UI labels map `action_rejected` ≠ executed and `outcome_not_measured` ≠ measured |
