# Worker SLA Evidence Capture — OBS09
...
Empty worker inventory is `inventoryStatus=unknown` with `worker_inventory_missing`, not “0 workers, therefore healthy”.
...
- inventing queue depth from “no jobs observed”
