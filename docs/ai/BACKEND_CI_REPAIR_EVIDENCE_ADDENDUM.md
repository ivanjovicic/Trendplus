...
Current READY prompt: none (current active prompt lives in the parent BCI queue: `BCI10` in DONE state)
Owner program: `BCI`
...
| BCI10 | DONE | Reopen current-main backend suite truth after SQL Server contract drift |
