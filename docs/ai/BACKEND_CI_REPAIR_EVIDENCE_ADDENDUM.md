...
Current READY prompt: none (current active prompt lives in the parent BCI queue: `BCI10` in PARTIAL state)
Owner program: `BCI`
...
| BCI10 | PARTIAL | Reopen current-main backend suite truth after SQL Server contract drift |
