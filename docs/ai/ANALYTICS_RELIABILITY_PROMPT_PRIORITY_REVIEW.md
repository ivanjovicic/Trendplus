...
- `docs/ai/ANALYTICS_RELIABILITY_PROMPT_QUEUE_TEST_HARDENING_ADDENDUM.md` - RQ100-RQ104 (`RQ103` READY; `RQ100`/`RQ101`/`RQ102` DONE)
...
6. Routing update 2026-08-13: `MASTER_ROADMAP.md` is authoritative. `BCI01`/`BCI05`/`BCI06` are DONE. Current RQ READY is `RQ103` after `RQ102` DONE. Follow-up pack `RQ104` stays WAITING. `RQ105` is WAITING operational-fallback honesty. Do not revive `RQ89`/`RQ90` as READY.
...
- Analytics correctness: `RQ103` READY after `RQ102` DONE. Follow-up pack `RQ104` stays WAITING in `ANALYTICS_RELIABILITY_PROMPT_QUEUE_TEST_HARDENING_ADDENDUM.md`. Strategy: `docs/ai/ANALYTICS_TEST_STRATEGY.md`.
- Do not revive `RQ100`/`RQ101`/`RQ102`; QDB exclusive work remains clear (`QDB06` still needs migration approval).
