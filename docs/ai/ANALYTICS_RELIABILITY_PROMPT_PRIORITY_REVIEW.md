...
- `docs/ai/ANALYTICS_RELIABILITY_PROMPT_QUEUE_TEST_HARDENING_ADDENDUM.md` - RQ100-RQ104 (`RQ104` READY; `RQ100`-`RQ103` DONE)
...
6. Routing update 2026-08-13: `MASTER_ROADMAP.md` is authoritative. `BCI01`/`BCI05`/`BCI06` are DONE. Current RQ READY is `RQ104` after `RQ103` DONE. `RQ105` is WAITING operational-fallback honesty. Do not revive `RQ89`/`RQ90` as READY.
...
- Analytics correctness: `RQ104` READY after `RQ103` DONE. Strategy: `docs/ai/ANALYTICS_TEST_STRATEGY.md`.
- Do not revive `RQ100`/`RQ101`/`RQ102`/`RQ103`; QDB exclusive work remains clear (`QDB06` still needs migration approval).
