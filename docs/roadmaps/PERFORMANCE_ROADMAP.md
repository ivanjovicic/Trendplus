...
- Risks:
  - D1-D7 remain deferred until a dedicated concurrency/envelope harness exists
  - shared_saas (D8) remains blocked on MT fixtures
- Next:
  - PERF11 when defined; otherwise the next PERF prompt should target D1/D2/D3 harnessing
