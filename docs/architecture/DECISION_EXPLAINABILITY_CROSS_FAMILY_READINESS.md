...
2. Inventory should follow with a stricter evidence-vs-workflow separation because its current fallback model can still blur operational status with decision truth.
