...
| PERF | `docs/ai/PLATFORM_EVOLUTION_PROMPT_QUEUE.md` + `docs/roadmaps/PERFORMANCE_ROADMAP.md` | `PERF12` | PERF11 DONE; D1 measured, D4/D5 blocked in `.ai/runs/2026-08-12-PERF11-evidence.md` | Yes, measurement when paths clear | remaining D4/D5-D7 gaps |
