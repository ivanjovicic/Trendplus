...
| RQ | `docs/ai/ANALYTICS_RELIABILITY_PROMPT_PRIORITY_REVIEW.md` plus source queues | none (`RQ95` DONE) | BCI05 READY override is active. RQ95 closed mojibake assert. | Selected docs/tests only | BCI05 re-entry |
