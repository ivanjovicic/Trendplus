...
| PERF | `docs/ai/PLATFORM_EVOLUTION_PROMPT_QUEUE.md` + `docs/roadmaps/PERFORMANCE_ROADMAP.md` | `PERF06` | `PERF05` DONE; M-tier pack in `.ai/runs/2026-08-12-PERF05-evidence.md` | Yes, cold-start investigation | PERF-COLD-01 profiling plan |
