...
|---|---|---|---|---|---|
| BCI | `MASTER_ROADMAP.md` / `docs/ai/BACKEND_CI_REPAIR_PROMPT_QUEUE.md` + `docs/ai/BACKEND_CI_REPAIR_EVIDENCE_ADDENDUM.md` | `BCI06` | `BCI01`/`BCI05` DONE. Green GHA `31674533356` on `f1f5a17`; current main is backend-equivalent. Next is Windows/VS mixed-solution verification. | Evidence/docs only | BCI06 mixed-solution proof |
...
| DEX | `docs/ai/DECISION_INTELLIGENCE_PROMPT_QUEUE.md` + `docs/roadmaps/DECISION_INTELLIGENCE_ROADMAP.md` | `DEX14` | `DEX13` DONE = inventory explainability reuse contract documented in `docs/architecture/DECISION_EXPLAINABILITY_INVENTORY_REUSE.md`; `DEX12` DONE = supplier explainability reuse contract documented in `docs/architecture/DECISION_EXPLAINABILITY_SUPPLIER_REUSE.md`; `DEX11` DONE = cross-family explainability readiness documented in `docs/architecture/DECISION_EXPLAINABILITY_CROSS_FAMILY_READINESS.md`; next is inventory explainability runtime slice | Yes, docs/contracts | Inventory Decision Surface explainability reuse |
