...
| P-UI | `docs/ai/ANALYTICS_UI_PREMIUM_PROMPT_QUEUE.md` + least-improved addendum | `P-UI-13` | P-UI-12 DONE (`ShoeTypeSalesStatsPage` → ControlBar + DataTable). Remaining legacy pages one-per-run. | Yes, when paths clear | P-UI-13 next legacy page (Color recommended) |
