...
| DT | same queue/roadmap as DEX | `DT05` (`DT03` DONE) | `DT01`/`DT02` DONE; `DT03` DONE = Slice-1 read-only timeline projection. | Yes, when paths clear | Await owner-promoted Slice-2 timeline API/UI slice |
