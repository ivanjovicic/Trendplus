...
| PERF | `docs/ai/PLATFORM_EVOLUTION_PROMPT_QUEUE.md` + `docs/roadmaps/PERFORMANCE_ROADMAP.md` | `PERF09` | PERF08 DONE; cold-start evidence in `.ai/runs/2026-08-12-PERF08-evidence.md` | Yes, docs/contracts | scalability gate evidence contract |
