...
|---|---|---|---|---|---|
| BCI | `MASTER_ROADMAP.md` / `docs/ai/BACKEND_CI_REPAIR_PROMPT_QUEUE.md` + `docs/ai/BACKEND_CI_REPAIR_EVIDENCE_ADDENDUM.md` | `BCI08` | `BCI01` is PARTIAL. `BCI05` is PARTIAL after the latest backend-equivalent GHA run `31575771867` (job `94047422144`) failed `829 total / 825 passed / 4 failed`; focused local repro on August 12, 2026 does not reproduce the family. | Evidence/docs only | Close `BCI08` isolation family -> re-enter `BCI05` -> green GHA -> BCI01 DONE |
