...
RAISE NOTICE '========================================';
RAISE NOTICE '? SETUP KOMPLETIRAN!';
RAISE NOTICE '========================================';
RAISE NOTICE '';
RAISE NOTICE 'Kreirano:';
RAISE NOTICE '- Sample artikli (ako ih nije bilo)';
RAISE NOTICE '- 10 artikala sa veli?inama/bojama';
RAISE NOTICE '- 5 test prodaja (DEMO-001 do DEMO-005)';
RAISE NOTICE '- Outbox eventi za Analytics';
RAISE NOTICE '';
RAISE NOTICE 'Slede?i koraci:';
RAISE NOTICE '1. Restart backend: cd Trendplus2 && dotnet run';
RAISE NOTICE '2. Sa?ekajte 90s da workers procesiraju';
