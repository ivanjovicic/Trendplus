...
public sealed class DataScopeConsistencyContractTests
{
    ...
    [Fact]
    public void CaptureAsync_NoSales_StillReportsArticleScopedZeroRevenue_NotFakeShares()
    {
        // Documents Capture current rule: revenue shares are article-origin scoped;
        // zero revenue must not invent percentages (paired with RQ04 HasRevenueEvidence).
