...
const supplierFootwearBreakdownSchema = z.object({
  ...
  marginContribution: finiteNumber,
  marginPct: percentage,
  shareOfSupplierRevenuePct: nullableNonNegativePercentage,
  shareOfSupplierMarginContributionPct: nullableNonNegativePercentage,
  previousPeriodRevenue: nullableNumber,
  previousPeriodUnits: nullableNumber,
  popRevenueChangePct: nullablePercentage,
  popUnitsChangePct: nullablePercentage,
...
const supplierSalesStatSchema = z.object({
  dobavljacId: nonNegativeInteger.nullable(),
  ...
  marginQualityTooltip: z.string().nullable(),
  revenueWithNivelacijaSplit: finiteNumber,
  comparableRevenueWithNivelacijaSplit: finiteNumber,
  previousPeriodRevenue: nullableNumber,
  previousPeriodUnits: nullableNumber,
  popRevenueChangePct: nullablePercentage,
  popUnitsChangePct: nullablePercentage,
  prePostNivelacijaRevenueImpactPct: nullablePercentage,
  prePostNivelacijaUnitsImpactPct: nullablePercentage,
  prePostNivelacijaRevenueCoveragePct: nullableNonNegativePercentage,
  prePostSignalNote: z.string().nullable(),
  prePostComparableArticleCount: nonNegativeInteger,
  primaryFootwearType: z.string(),
  primaryFootwearTypeSharePct: nullableNonNegativePercentage,
  footwearTypeCount: nonNegativeInteger,
  footwearBreakdown: z.array(supplierFootwearBreakdownSchema),
  sharePct: nullableNonNegativePercentage,
  shareOfMarginContribution: nullableNonNegativePercentage,
  shareOfProfit: nullableNonNegativePercentage,
  shareOfUnits: nullableNonNegativePercentage,
  reliabilityPct: nullableNonNegativePercentage,
  recommendation: supplierRecommendationSchema,
  promenaPrometa: nullablePercentage,
  promenaKolicine: nullablePercentage,
}).passthrough();

const supplierSalesTotalsSchema = z.object({
  ukupanPromet: finiteNumber,
  ukupanMarzniDoprinos: finiteNumber,
  ukupanTrosak: finiteNumber,
  prosecnaMarza: nullablePercentage,
  ...
  marginBenchmarkBasis: z.string().nullable(),
  historicalCostCoveragePct: nonNegativePercentage,
  estimatedCostCoveragePct: nonNegativePercentage,
  noCostCoveragePct: nonNegativePercentage,
  snapshotCostRevenue: finiteNumber,
  snapshotCostCoveragePct: nonNegativePercentage,
  isSnapshotActive: z.boolean(),
  snapshotGeneratedAtUtc: validDate.nullable(),
  isEstimatedMargin: z.boolean(),
  marginQualityLabel: z.string().nullable(),
  ...
  brojDobavljacTipObuceKombinacija: nonNegativeInteger,
  popRevenueChangePct: nullablePercentage,
  popUnitsChangePct: nullablePercentage,
  prePostNivelacijaRevenueImpactPct: nullablePercentage,
  prePostNivelacijaUnitsImpactPct: nullablePercentage,
  ...
  promenaPrometaPct: nullablePercentage,
}).passthrough();

const supplierSalesDataQualitySchema = z.object({
  ...
  costSourceBasis: z.string().nullable(),
...
export const supplierSalesStatsResponseSchema = z.object({
  ...
  storeId: nonNegativeInteger.nullable(),
  dataScope: z.enum(["all", "existing", "imported"]),
  provenanceBasis: z.string().nullable(),
  recommendationAllowed: z.boolean().nullable(),
  ...
  suppliers: z.array(supplierSalesStatSchema),
  totals: supplierSalesTotalsSchema,
  dataQuality: supplierSalesDataQualitySchema,
  sezone: z.array(seasonSchema),
}).passthrough();
