...
const supplierRecommendationSchema = z.object({
  status: z.enum(["increase_focus", "maintain", "review", "do_not_trust", "insufficient_data"]),
  label: z.string().trim().min(1),
  summary: z.string(),
  confidencePct: nullableNonNegativePercentage,
...
const supplierFootwearBreakdownSchema = z.object({
  ...
  ukupanPromet: finiteNumber,
  ukupnaKolicina: finiteNumber,
  brojArtikala: nonNegativeInteger,
  totalCost: finiteNumber,
  marginContribution: finiteNumber,
  marginPct: finiteNumber,
  shareOfSupplierRevenuePct: nullableNumber,
  shareOfSupplierMarginContributionPct: nullableNumber,
  previousPeriodRevenue: nullableNumber,
  previousPeriodUnits: nullableSignedInteger,
  popRevenueChangePct: nullableNumber,
  popUnitsChangePct: nullableNumber,
  historicalCostRevenue: finiteNumber.optional(),
  historicalCostCoveragePct: nullableNumber.optional(),
  estimatedCostRevenue: finiteNumber.optional(),
  estimatedCostCoveragePct: nullableNumber.optional(),
  snapshotCostRevenue: finiteNumber.optional(),
  snapshotCostCoveragePct: nullableNumber.optional(),
  noCostRevenue: finiteNumber.optional(),
  noCostCoveragePct: nullableNumber.optional(),
  marginQualityLabel: z.string().nullable().optional(),
...
const supplierSalesStatSchema = {
  ...
  posleNivelacijePromet: finiteNumber,
  posleNivelacijeKolicina: finiteNumber,
  comparablePreNivelacijePromet: finiteNumber.optional(),
  comparablePostNivelacijePromet: finiteNumber.optional(),
  comparablePreNivelacijeKolicina: finiteNumber.optional(),
  comparablePostNivelacijeKolicina: finiteNumber.optional(),
  ukupanPromet: finiteNumber,
  ukupnaKolicina: finiteNumber,
  previousPeriodRevenue: nullableNumber,
  previousPeriodUnits: nullableSignedInteger,
  ...
  estimatedCostCoveragePct: nullableNumber,
  snapshotCostRevenue: finiteNumber,
  snapshotCostCoveragePct: nullableNumber,
  noCostRevenue: finiteNumber,
  noCostCoveragePct: nullableNumber,
  isEstimatedMargin: z.boolean(),
  marginQualityLabel: z.string().nullable(),
  marginQualityTier: z.string().nullable(),
  marginQualityShortLabel: z.string().nullable(),
  ...
  prePostNivelacijaRevenueImpactPct: nullableNumber,
  prePostNivelacijaUnitsImpactPct: nullableNumber,
  prePostNivelacijaRevenueCoveragePct: nullableNumber,
  prePostSignalNote: z.string().nullable(),
  prePostComparableArticleCount: nonNegativeInteger,
  primaryFootwearType: z.string().nullable(),
  primaryFootwearTypeSharePct: nullableNumber,
  footwearTypeCount: nonNegativeInteger,
  footwearBreakdown: z.array(supplierFootwearBreakdownSchema),
  sharePct: nullableNumber,
  shareOfMarginContribution: nullableNumber,
  shareOfProfit: nullableNumber,
...
const supplierDataQualitySchema = z.object({
  missingCostQty: finiteNumber,
  missingCostRevenue: finiteNumber,
  missingCostRevenueSharePct: nullableNonNegativePercentage,
  noCostRevenue: finiteNumber,
  noCostRevenueSharePct: nullableNonNegativePercentage,
  costCoveredRevenue: finiteNumber,
  costCoveredRevenueSharePct: nullableNonNegativePercentage,
  historicalCostRevenue: finiteNumber,
  historicalCostRevenueSharePct: nullableNonNegativePercentage,
  snapshotCostRevenue: finiteNumber,
  snapshotCostRevenueSharePct: nullableNonNegativePercentage,
  estimatedCostRevenue: finiteNumber,
  estimatedCostRevenueSharePct: nullableNonNegativePercentage,
  costSourceBasis: z.string().trim().min(1),
  unknownSupplierRevenue: finiteNumber,
  unknownSupplierRevenueSharePct: nullableNonNegativePercentage,
  revenueWithNivelacijaSplit: finiteNumber,
  revenueWithNivelacijaSplitSharePct: nullableNumber,
}).passthrough();

export const supplierSalesStatsResponseSchema = z.object({
  generatedAt: validDate,
  meta: analyticsResponseMetaSchema,
  fromDate: validDate.nullable(),
  toDate: validDate.nullable(),
  ...
  recommendationAllowed: z.boolean().nullable().optional(),
  recommendationReferenceCohort: z.object({
    scope: z.literal("all_response_suppliers"),
    supplierCount: nonNegativeInteger,
    includesUnknown: z.boolean(),
    basis: z.string().trim().min(1),
  }).nullable().optional(),
  suppliers: z.array(z.object(supplierSalesStatSchema).passthrough()),
  totals: z.object({
    ukupanPromet: finiteNumber,
    ukupanMarzniDoprinos: finiteNumber,
    ukupanTrosak: finiteNumber.optional(),
    prosecnaMarza: nullableNumber,
    weightedMarginRevenue: finiteNumber,
    weightedMarginContribution: finiteNumber,
    marginBenchmarkBasis: z.string().trim().min(1),
    historicalCostCoveragePct: nullableNumber,
    estimatedCostCoveragePct: nullableNumber,
    noCostCoveragePct: nullableNumber,
    snapshotCostRevenue: finiteNumber,
    ...
    preKolicina: finiteNumber,
    posleKolicina: finiteNumber,
    observedPrePromet: finiteNumber.optional(),
    observedPoslePromet: finiteNumber.optional(),
    observedPreKolicina: finiteNumber.optional(),
    observedPosleKolicina: finiteNumber.optional(),
    comparablePrePromet: finiteNumber.optional(),
    comparablePoslePromet: finiteNumber.optional(),
    comparablePreKolicina: finiteNumber.optional(),
    comparablePosleKolicina: finiteNumber.optional(),
    prePostComparableArticleCount: nonNegativeInteger.optional(),
    prePostNivelacijaRevenueCoveragePct: nullableNumber.optional(),
    prePostSignalNote: z.string().nullable().optional(),
    previousPeriodRevenue: nullableNumber,
    previousPeriodUnits: nullableSignedInteger,
    brojDobavljaca: nonNegativeInteger,
    brojDobavljacTipObuceKombinacija: nonNegativeInteger.optional(),
    popRevenueChangePct: nullableNumber,
    popUnitsChangePct: nullableNumber,
    prePostNivelacijaRevenueImpactPct: nullableNumber,
    prePostNivelacijaUnitsImpactPct: nullableNumber,
  ...
  dataQuality: supplierDataQualitySchema,
  sezone: z.array(seasonSchema),
}).passthrough();
...
const dailySalesMetadataSchema = z.object({
  ...
  receiptReconciliation: z.object({
    ...
    matchedReceiptCount: nullableNonNegativeInteger,
    unmatchedReceiptCount: nullableNonNegativeInteger,
    unmatchedDnevnikReceiptCount: nullableNonNegativeInteger,
    mismatchCount: nullableNonNegativeInteger,
    mismatchAmount: nullableNonNegativeNumber,
  }).optional(),
...
export const preNivelacijaPriorityResponseSchema = z.object({
  ...
  summary: z.object({
    ...
    totalStockAtRisk: nullableNonNegativeInteger,
    totalStockAtRiskCoverageEligible: nonNegativeInteger,
    totalStockAtRiskCoverageTotal: nonNegativeInteger,
    estimatedAvoidableMarkdownLoss: nullableNumber,
    estimatedAvoidableMarkdownLossCoverageEligible: nonNegativeInteger,
    estimatedAvoidableMarkdownLossCoverageTotal: nonNegativeInteger,
    expectedHighlightRevenueUplift: nullableNumber,
    expectedHighlightRevenueUpliftCoverageEligible: nonNegativeInteger,
    expectedHighlightRevenueUpliftCoverageTotal: nonNegativeInteger,
