            ...
            <div className="grid gap-4 mb-8" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))" }}>
                {Array.from({ length: 5 }).map((_, idx) => (
                    <div
                        ...
                        style={{
                            background: "linear-gradient(90deg, var(--surface-elevated, var(--theme-color-f3f4f6, #f3f4f6)) 25%, var(--surface-default, var(--theme-color-e5e7eb, #e5e7eb)) 50%, var(--surface-elevated, var(--theme-color-f3f4f6, #f3f4f6)) 75%)",
                                ...
                                {Array.from({ length: 5 }).map((_, idx) => (
                                    <th key={idx} className="p-3">
                                        <div
                                            ...
                                            style={{
                                                background: "var(--surface-default, var(--theme-color-e5e7eb, #e5e7eb))",
                                                height: "16px",
                                            }}
                                        />
                                    </th>
