    ...
    return (
        <div style={{ maxWidth: 1380, margin: "2rem auto", padding: "0 1rem", fontFamily: "system-ui, -apple-system, sans-serif" }}>
            ...
            <div style={{ marginBottom: 24 }}>
                <h1 style={{ fontSize: 26, fontWeight: 800, color: "var(--text-strong, var(--theme-color-111827, #111827))", margin: 0 }}>
                    🛍 Amazon Shoe Trends
                </h1>
                <p style={{ color: "var(--text-muted, var(--theme-color-6b7280, #6b7280))", marginTop: 4, marginBottom: 0, fontSize: 14 }}>
            ...
            <div style={{ background: "var(--surface-card, var(--theme-color-ffffff, #ffffff))", border: "1px solid var(--border-muted, var(--theme-color-e5e7eb, #e5e7eb))", borderRadius: 14, padding: "18px 20px", marginBottom: 20, boxShadow: "var(--box-shadow-xs, 0 1px 4px var(--theme-color-rgba-0-0-0-p06, rgba(0,0,0,.06)))" }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "var(--text-strong, var(--theme-color-111827, #111827))", marginBottom: 12 }}>🔄 Sync from Amazon</div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 10, alignItems: "flex-end" }}>

                    {/* Type */}
                    <div>
                        <label style={{ display: "block", fontSize: 11, fontWeight: 600, color: "var(--text-muted, var(--theme-color-6b7280, #6b7280))", marginBottom: 4 }}>Tip cipele</label>
                    ...
                    {/* Gender */}
                    <div>
                        <label style={{ display: "block", fontSize: 11, fontWeight: 600, color: "var(--text-muted, var(--theme-color-6b7280, #6b7280))", marginBottom: 4 }}>Pol</label>
                        <select
                            value={syncGender}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: syncing ? "var(--border-muted, var(--theme-color-e5e7eb, #e5e7eb))" : "var(--accent, var(--theme-color-4f46e5, #4f46e5))",
                            color: syncing ? "var(--text-muted, var(--theme-color-9ca3af, #9ca3af))" : "var(--text-on-accent, white)",
                ...
                <div style={{ marginTop: 8, fontSize: 11, color: "var(--text-secondary, var(--theme-color-9ca3af, #9ca3af))" }}>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                    <select
                                        ...
                                        style={{ padding: "4px 8px", borderRadius: 7, border: `1.5px solid ${brandFilter !== "all" ? "var(--accent, var(--theme-color-6366f1, #6366f1))" : "var(--border-muted, var(--theme-color-e5e7eb, #e5e7eb))"}`, fontSize: 12, fontWeight: brandFilter !== "all" ? 700 : 400, color: brandFilter !== "all" ? "var(--accent, var(--theme-color-4f46e5, #4f46e5))" : "var(--text-secondary, var(--theme-color-374151, #374151))", background: brandFilter !== "all" ? "var(--accent-100, var(--theme-color-eef2ff, #eef2ff))" : "var(--surface-light, var(--theme-color-ffffff, #ffffff))", cursor: "pointer" }}
                                    >
                                        ...
                                        style={{ padding: "4px 8px", borderRadius: 7, border: "1.5px solid var(--border-muted, var(--theme-color-e5e7eb, #e5e7eb))", fontSize: 12, fontWeight: 600, background: "var(--surface-light, var(--theme-color-ffffff, #ffffff))", cursor: "pointer" }}
                                    >
                                ...
                                {GENDER_OPTIONS.map((g) => (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            border: `1.5px solid ${browseGender === g.value ? "var(--accent, var(--theme-color-4f46e5, #4f46e5))" : "var(--border-muted, var(--theme-color-e5e7eb, #e5e7eb))"}`,
                                            background: browseGender === g.value ? "var(--accent, var(--theme-color-4f46e5, #4f46e5))" : "var(--surface-light, var(--theme-color-ffffff, #ffffff))",
                                            color: browseGender === g.value ? "var(--text-on-primary, var(--theme-color-ffffff, #ffffff))" : "var(--text-secondary, var(--theme-color-374151, #374151))",
                        ...
                        return (
                            <>
                                ...
                                {displayedItems.length === 0 && selectedType && !loadingItems && (
                                    <div style={{ textAlign: "center", padding: 40, background: "var(--surface-default, var(--theme-color-f9fafb, #f9fafb))", borderRadius: 14, color: "var(--muted, var(--theme-color-6b7280, #6b7280))" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", marginTop: 24 }}>
                            <button
                                ...
                                style={{
                                    ...
                                    background: loadingMore ? "var(--border-muted, var(--theme-color-e5e7eb, #e5e7eb))" : "var(--accent, var(--theme-color-4f46e5, #4f46e5))",
                                    color: loadingMore ? "var(--text-muted, var(--theme-color-9ca3af, #9ca3af))" : "var(--text-on-primary, var(--theme-color-ffffff, #ffffff))",
