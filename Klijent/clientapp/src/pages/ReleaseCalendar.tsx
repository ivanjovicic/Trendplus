...
export default function ReleaseCalendar() {
    ...
    return (
        <div className="card">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                    ...
                    <button
                        ...
                        style={{ background: 'var(--c-3b82f6, #3b82f6)', marginLeft: 8 }}
                    >
                        🔄 Refresh
                    </button>
                </div>
            ...
            {error && <div style={{ color: 'var(--c-dc2626, #dc2626)' }}>Error: {error}</div>}
                    ...
                    {items.map((p, i) => (
                        <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                            ...
                            <div>
                                ...
                                {p.coming_soon && <div style={{ color: 'var(--c-059669, #059669)', fontWeight: 700 }}>Coming: {p.release_date}</div>}
                            </div>
                        </div>
                    ))}
                </div>
