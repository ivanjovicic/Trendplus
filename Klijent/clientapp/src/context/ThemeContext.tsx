...
const COMMON_VARS: Record<string, string> = {
  ...
  "--analytics-page-bg": "radial-gradient(70rem 42rem at 100% 0%, color-mix(in srgb, var(--accent-secondary) 12%, transparent), transparent 58%), radial-gradient(56rem 36rem at 0% 4%, color-mix(in srgb, var(--accent-primary) 10%, transparent), transparent 62%), linear-gradient(160deg, var(--surface-default), var(--surface-darker))",
  ...
  "--analytics-accent-2": "var(--accent-secondary)",
...
const THEMES: Record<ThemeName, Theme> = {
  ...
  "soft-gray": {
    ...
    cssVars: withBaseVars({
      ...
      "--warning": "var(--theme-color-f59e0b, #f59e0b)",
      "--info": "var(--theme-color-3b82f6, #3b82f6)",
      "--analytics-glow": "0 0 18px color-mix(in srgb, var(--accent-primary) 10%, transparent)",
      "--analytics-glow-strong": "0 0 28px color-mix(in srgb, var(--accent-primary) 16%, transparent)",
    }),
  },
  light: {
    name: "light",
